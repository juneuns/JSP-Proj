...
<%-- 			<c:if test="${not empty SID }"> 아이디가 같으면 실행 --%>
				<div class="w3-col m2 w3-right w3-button" style="padding: 0px;">댓글작성</div>
<%-- 			</c:if> --%>				
				<div class="w3-row">
					<div class="w3-col m2"><p></p></div>
					<%-- <c:forEach var="data" items="${LIST}"> --%>
						<div class="w3-col m10 w3-left w3-padding w3-border" style="height: 70px;">
							<h6 class="w3-col" style="margin: 0px;">첫 댓글 등록</h6>
							<div class="w3-col m9 w3-border"><p></p></div>
							<%-- <c:if test="${not empty SID }"> 로그인되어있으면 --%>
								<div class="w3-col m1 w3-center w3-border w3-button" style="padding: 0px;">작성</div>
							<%-- </c:if> --%>
							<%-- <c:if test="${not empty SID}"> 아이디가 같으면 --%>
								<div class="w3-col m1 w3-center w3-border w3-button" style="padding: 0px;">수정</div>
								<div class="w3-col m1 w3-center w3-border w3-button" style="padding: 0px;">삭제</div>
							<%-- </c:if> --%>
						</div>
					<%-- </c:forEach> --%>
				</div>
