...
public class PageUtil {
	// 변수 선언
	private int nowPage;	// 내가 페이징 처리한 페이지가 몇번째 숫자인지 알려주는 변수
	...
	/*
	 	댓글이 하나만 있을경우 해당 글이 삭제되면 페이지가 없어져야 한다.
	 	위의 경우는 startCont == endCont가 같은경우 가 이에 해당한다.
	 	이때 글이 보이지 않기 위해선 startCont -= 1; 로 만들어 줘야겠다.
	 */
	public PageUtil() {}
	...
	public void calcStart() {
		...
		// 팁 : 한 화면에 보여지는 페이지수에서 현재페이지를 나눴을 때 같은값이 되기 이전에는 1이 되며, 같은 경우는 페이지수 + 1이 된다.
